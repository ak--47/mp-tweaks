...
function mixpanel_with_session_replay(project_token, lib_url, proxy_url) {
	...
	const MIXPANEL_CUSTOM_LIB_URL = lib_url || `./src/lib/mixpanel.dev.min.js`;
	const MIXPANEL_PROXY_URL = proxy_url || `https://api-js.mixpanel.com`;

	// MIXPANEL SNIPPET
	// NOTE: MODIFIED TO USE INTERNAL CUSTOM LIB URL WHICH IS LOADED LOCALLY SO NO REMOTE JS FILES ARE FETCHED
	(function (f, b) {
		if (!b.__SV) {
			...
			}; b.__SV = 1.2; e = f.createElement("script"); e.type = "text/javascript"; e.async = !0; e.src = "undefined" !== typeof MIXPANEL_CUSTOM_LIB_URL ? MIXPANEL_CUSTOM_LIB_URL : "file:" === f.location.protocol && "/src/lib/mixpanel.dev.min.js".match(/^\/\//) ? "./src/lib/mixpanel.dev.min.js" : "./src/lib/mixpanel.dev.min.js"; g = f.getElementsByTagName("script")[0]; g.parentNode.insertBefore(e, g);
		}
