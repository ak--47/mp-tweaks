(() => {
	...
	var require_mixpanel_cjs = __commonJS({
	  "node_modules/mixpanel-browser/dist/mixpanel.cjs.js"(exports, module) {
		...
		var DEFAULT_CONFIG = {
		  ...
		  "recorder_src":  chrome.runtime.getURL('/src/lib/mixpanel-recorder.min.js')  //"https://cdn.mxpnl.com/libs/mixpanel-recorder.min.js"
		};
	...
	// bundle/mixpanel-vanilla.js
	var PROXY = `https://express-proxy-lmozz6xkha-uc.a.run.app`;
	import_mixpanel_browser.default.load = function(token) {
	  import_mixpanel_browser.default.init(token, {
		...
		loaded: function(mixpanel2) {
		  console.log("mixpanel SDK loaded\ncurrent distinct_id:", mixpanel2.get_distinct_id());
		}
	  });
	};
	console.log(`
--------------------		
MIXPANEL SDK IS INJECTED IN THIS TAB; now type

	mixpanel.load('your-token')
  
to initialize the SDK with your mixpanel project; after thatyou can use any of the API methods in the docs
