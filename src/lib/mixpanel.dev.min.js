...
function M(a){return ia(a,function(a){return this.c(a)})}function H(a){return ia(a,function(a){return this.p(a)})}function N(a){return ia(a,function(a){return this.p(a)})}function La(a,b){b=b||{};V(b).remove(W(a,b),!!b.xb,b.vb)}function V(a){a=a||{};return"localStorage"===a.Pb?c.localStorage:c.cookie}function W(a,b){b=b||{};return(b.Ob||Ma)+a}function Ka(a){if(a&&a.Eb)return D;var a=a&&a.window||n,b=a.navigator||{},d=D;c.a([b.doNotTrack,b.msDoNotTrack,a.doNotTrack],function(a){c.j([m,1,"1","yes"],
...
try{y.error.apply(y,a)}catch(b){c.a(a,function(a){y.error(a)})}}},A:function(){if(!c.g(y)&&y){var a=["Mixpanel error:"].concat(c.O(arguments));try{y.error.apply(y,a)}catch(b){c.a(a,function(a){y.error(a)})}}}};c.bind=function(a,b){var d,f;if(ja&&a.bind===ja)return ja.apply(a,K.call(arguments,1));if(!c.Va(a))throw new TypeError;d=K.call(arguments,2);return f=function(){if(!(this instanceof f))return a.apply(b,d.concat(K.call(arguments)));var c={};c.prototype=a.prototype;var g=new c;c.prototype=r;c=
a.apply(g,d.concat(K.call(arguments)));return Object(c)===c?c:g}};c.a=function(a,b,d){if(!(a===r||a===l))if(va&&a.forEach===va)a.forEach(b,d);else if(a.length===+a.length)for(var c=0,h=a.length;c<h&&!(c in a&&b.call(d,a[c],c,a)===ka);c++);else for(c in a)if(X.call(a,c)&&b.call(d,a[c],c,a)===ka)break};c.extend=function(a){c.a(K.call(arguments,1),function(b){for(var d in b)b[d]!==l&&(a[d]=b[d])});return a};c.isArray=A||function(a){return"[object Array]"===Q.call(a)};c.Va=function(a){try{return/^\s*\bfunction\b/.test(a)}catch(b){return D}};
c.Kc=function(a){return!(!a||!X.call(a,"callee"))};c.O=function(a){return!a?[]:a.O?a.O():c.isArray(a)||c.Kc(a)?K.call(a):c.xd(a)};c.map=function(a,b,d){if(xa&&a.map===xa)return a.map(b,d);var f=[];c.a(a,function(a){f.push(b.call(d,a))});return f};c.keys=function(a){var b=[];if(a===r)return b;c.a(a,function(a,c){b[b.length]=c});return b};c.xd=function(a){var b=[];if(a===r)return b;c.a(a,function(a){b[b.length]=a});return b};c.Ta=function(a,b){var d=D;if(a===r)return d;if(wa&&a.indexOf===wa)return-1!=
...
aa:function(a){"object"!==typeof a&&(a={});return c.extend(c.fa({$os:c.info.Mb(),$browser:c.info.ma(z,I.vendor,Y),$referrer:t.referrer,$referring_domain:c.info.Rb(t.referrer),$device:c.info.Bb(z)}),{$current_url:c.info.La(),$browser_version:c.info.Ia(z,I.vendor,Y),$screen_height:Z.height,$screen_width:Z.width,mp_lib:"web",$lib_version:"2.50.0-alpha-4",$insert_id:ea(),time:c.timestamp()/1E3},c.fa(a))},Rc:function(){return c.extend(c.fa({$os:c.info.Mb(),$browser:c.info.ma(z,I.vendor,Y)}),{$browser_version:c.info.Ia(z,
...
g,c,m),e);h.Jb.o(b,g,h.fc(f,g,c))})},this),m};E.prototype.fc=function(a,b,c,f){var f=f||D,h=this;return function(){if(!c.yc)c.yc=m,a&&a(f,b)===D||h.Ga(b,c,f)}};E.prototype.oa=function(a,b){return"function"===typeof a?a(b):c.extend({},a)};c.Gb(L,E);L.prototype.oa=function(a,b){var c=L.ld.oa.apply(this,arguments);if(b.href)c.url=b.href;return c};L.prototype.Oa=function(a,b,c){c.Kb=2===a.which||a.metaKey||a.ctrlKey||"_blank"===b.target;c.href=b.href;c.Kb||a.preventDefault()};L.prototype.Ga=function(a,
...
typeof a?this.U.Ac=m:this.xa=this.xa.concat(a)};e.prototype.lb=function(a){a=c.ha(a);"base64"===this.c("api_payload_format")&&(a=c.xc(a));return{data:a}};e.prototype.Fa=function(a,b){var d=c.truncate(a.data,255),e=a.F,h=a.Ha,g=a.gd,j=a.$c||{},b=b||P,i=m,k=c.bind(function(){j.bc||(d=this.pb("before_send_"+a.type,d));return d?(o.log("MIXPANEL REQUEST:"),o.log(d),this.k(e,this.lb(d),j,this.nb(b,d))):r},this);this.T&&!g?h.Na(d,function(a){a?b(1,d):k()}):i=k();return i&&d};e.prototype.o=M(function(a,b,
...
g,this.persistence.aa(),this.P,b);g=this.c("property_blacklist");c.isArray(g)?c.a(g,function(a){delete b[a]}):this.l("Invalid value for property_blacklist config: "+g);return this.Fa({type:"events",data:{event:a,properties:b},F:this.c("api_host")+"/"+this.c("api_routes").track,Ha:this.u.K,gd:h,$c:d},e)}});e.prototype.ed=M(function(a,b,d){c.isArray(b)||(b=[b]);var e={};e[a]=b;this.m(e);return this.people.set(a,b,d)});e.prototype.uc=M(function(a,b,c){var e=this.s(a),h={};e===l?(h[a]=[b],this.m(h)):
-1===e.indexOf(b)&&(e.push(b),h[a]=e,this.m(h));return this.people.ga(a,b,c)});e.prototype.Uc=M(function(a,b,c){var e=this.s(a);if(e!==l){var h=e.indexOf(b);-1<h&&(e.splice(h,1),this.m({Bd:e}));0===e.length&&this.Q(a)}return this.people.remove(a,b,c)});e.prototype.td=M(function(a,b,d,e){var h=c.extend({},b||{});c.a(d,function(a,b){a!==r&&a!==l&&(h[b]=a)});return this.o(a,h,e)});e.prototype.oc=function(a,b){return a+"_"+JSON.stringify(b)};e.prototype.Gc=function(a,b){var c=this.oc(a,b),e=this.kb[c];
if(e===l||e.Ca!==a||e.Ba!==b)e=new u,e.X(this,a,b),this.kb[c]=e;return e};e.prototype.eb=M(function(a,b){"object"!==typeof a&&(a={});var b=b||{},d=b.event_name||"$mp_web_page_view",e=c.extend(c.info.Oc(),c.info.Y(),c.info.ub()),e=c.extend({},e,a);return this.o(d,e)});e.prototype.sd=function(){return this.Ea.call(this,L,arguments)};e.prototype.rd=function(){return this.Ea.call(this,T,arguments)};e.prototype.md=function(a){c.g(a)?this.l("No event name provided to mixpanel.time_event"):this.mb(a)||this.persistence.dd(a)};
